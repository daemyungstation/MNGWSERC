...
for (var i = 0; i < sSrc.length; i++) 
{
	...
	if (s.match(/CODBoardCtgr.js?/) != null) 
	{
        var qsE = s.split("/common/js/mngwserc/co/cod/CODBoardCtgr.js");
	...
	jQuery("#divCategoris")	
		...
		.jstree({ 
			...
			"types" : {
				...
				"valid_children" : [ "drive" , "folder" , "etc" ],
				"types" : {
					// The default type
					"etc" : {
...
function updateMenuInf()
{
	...
	else
	{
		if(confirm("적용하시겠습니까?"))
		{
			jQuery.post("/mngwserc/cod/adm/updateUserUseYn.ajax",
				{
					"menuSeq": id,
					"menuGb": CategoryInfo.menuGb,
