...
for (var i = 0; i < sSrc.length; i++) 
{
	...
	if (s.match(/CNALimitedChoiceCategory.js?/) != null)
	{
        var qsE = s.split("/common/js/mngwserc/cn/cna/CNALimitedChoiceCategory.js");
...
jQuery(function(){
	jQuery("#divCategoris")	
		...
		.jstree({ 
			...
			"json_data" : { 
				...
				"ajax" : {
					...
					"url" : "/mngwserc/cna/limited/category/getCateJson.ajax",
		...
		.bind("create.jstree", function (event, data) {
			...
			{
				jQuery.post("/mngwserc/cna/limited/category/insertCateMenu.ajax",
					{ 
		...
		.bind("rename.jstree", function (event, data) {
			...
			{
				jQuery.post("/mngwserc/cna/limited/category/updateCateMenuNm.ajax",
					{ 
		...
		.bind("remove.jstree", function (event, data) {
			if (data.rslt.obj == undefined)
			{
				if(confirm("삭제하시겠습니까?"))
				{
					jQuery.post("/mngwserc/cna/limited/category/deleteCateMenu.ajax",
						{ 
		...
		.bind("move_node.jstree", function (event, data) {
			...
			if(confirm("이동 하시겠습니까?"))
			{
				data.rslt.o.each(function () {
					jQuery.post("/mngwserc/cna/limited/category/updateCateMenuPstn.ajax",
						{
