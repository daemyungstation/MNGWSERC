...
<%
	...
	** 별도 생성하여 사용할 경우 동일 거래번호를 두번 사용할 수 없는 것에 주의하여 작성. **/
	...
	//String returnUrl = "http://"+request.getServerName()+":8080/mngwsercgateway/phoneAuth3.do";// 본인인증 완료후 리턴될 URL (도메인 포함 full path) LOCAL
	String returnUrl = "https://"+request.getServerName()+"/mngwsercgateway/phoneAuth3.do";// 본인인증 완료후 리턴될 URL (도메인 포함 full path)
	if ("sales.daemyungimready.com".equals(request.getServerName()))
	{
		returnUrl = "https://"+request.getServerName()+"/mngwsercgateway/phoneAuth3.do";// 본인인증 완료후 리턴될 URL (도메인 포함 full path)
	}
