...
<!-- 
	...
	######################################################################
-->
<form name="searchFrm" method="post" action="${pageLink}">
	  	...
	  	<div class="modal-dialog">
	    	<div class="modal-content">
	      		<div class="modal-header">
	        		...
	        		<h4 class="modal-title" id="myModalLabel">Main 배너 등록</h4>
	      		</div>
	      		<div class="modal-body" style="text-align:center;">
	      			<%@ include file="./CNAMainBannerPop.jsp" %>	      		
	      		</div>
...
<script type="text/javascript">
	...
	function view(seq)
	{
		$.ajax({
			...
			success: function(res) {
				...
				//$("input[name='urlText']").val(mgrInfo.url);
	...
	{
		$.ajax({
			url: "/mngwserc/cna/banner/MAIN/write.ajax",
			type: "post",
			dataType: "json",
	...
	function deleteBanner()
	{
		if(jQuery("input:checkbox[name='delSeq']:checked").length > 0)
		{
			if(confirm("삭제하시겠습니까?")) 
			{
				...
				f.action = "/mngwserc/cna/banner/MAIN/bannerDelete.do";
				f.submit();
			}
		} 
		else 
