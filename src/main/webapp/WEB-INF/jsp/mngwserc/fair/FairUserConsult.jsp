...
<%--	/*BLOCK_EXCEL*/		<a class="btn btn-success" style="float:right;" onclick="javascript:search_excel();">엑셀다운</a>--%>
		</div>
	</div>
		...
		<c:forEach var="list" items="${rtnMap.list}" varStatus="status">
 			<tr>
			    ...
			    <td style="text-align:left;">${list.fpMainTitle}</td>
			   	<td class="input_name" style="text-align:center; cursor:pointer; text-decoration: underline;" onclick="javascript:document.location.href='./consultdetail.do?fupSeq=${list.fupSeq}';"></td>
			   	<td class="input_phone" style="text-align:center; cursor:pointer; text-decoration: underline;" onclick="javascript:document.location.href='./consultdetail.do?fupSeq=${list.fupSeq}';"></td>
			    ...
			    <td style="text-align:center;">${list.fupcStatus}<textarea class="userInput" style="display:none;">${list.fupValue}</textarea></td>
		  	</tr>
	 	</c:forEach>
	 </table>
</form>
...
// 				console.log(data);
	...
	// function search_excel() { /*BLOCK_EXCEL*/
