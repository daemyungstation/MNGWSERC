package mngwserc.cn.cnb.service.impl;
...
import mngwserc.cn.cnb.service.dao.CNBOprtGuideDAO;
 ...
 * </pre>
 * 
 * @ClassName		: SMDOprtGuideServiceImpl.java
 ...
 * </pre>
 */
@Service("cNBOprtGuideService")
public class CNBOprtGuideServiceImpl extends EmfAbstractService implements CNBOprtGuideService {

	@Resource(name="cNBOprtGuideDAO")
    private CNBOprtGuideDAO cNBOprtGuideDAO;
	...
	public EmfMap selectOprtGuideList(EmfMap emfMap) throws Exception
    {
		...
		//리스트 가져오기
		List<EmfMap> list = cNBOprtGuideDAO.selectOprtGuideList(emfMap);
    ...
    {	
    	...
    	{
			EmfMap oprtGuideInfo = cNBOprtGuideDAO.selectOprtGuide(emfMap);
...
//	public void insertOprtGuide(EmfMap emfMap) throws Exception
	public void iog(EmfMap emfMap) throws Exception
	{
		...
		cNBOprtGuideDAO.insertOprtGuide(emfMap);				
	}
...
//	public void updateOprtGuide(EmfMap emfMap) throws Exception
	public void uog(EmfMap emfMap) throws Exception
	{
		...
		cNBOprtGuideDAO.updateOprtGuide(emfMap);				
	}
...
//	public void deleteOprtGuideList(int[] delSeq) throws Exception
	...
	{	
		...
		cNBOprtGuideDAO.deleteOprtGuide(emfMap);
	}
...
//	public void insertOprtGuideCopy(EmfMap emfMap) throws Exception 
	public void iogc(EmfMap emfMap) throws Exception 
	{
		...
		cNBOprtGuideDAO.insertOprtGuideCopy(emfMap);
	}
