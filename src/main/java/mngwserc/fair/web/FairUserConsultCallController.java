...
@Controller
@RequestMapping(value="/mngwserc/fair/userconsultcall")
public class FairUserConsultCallController extends EmfController {
	...
	public String selectUserExcel(EmfMap emfMap, ModelMap modelMap) throws Exception
	{
		try
		{		
			EmfMap rtnMap = fairService.selectListExcelCall(emfMap);
...
//    		modelMap.addAttribute("memoMap", memoMap);
    	...
    	return "mngwserc/fair/FairUserConsultCallDetail.admin";
    }
