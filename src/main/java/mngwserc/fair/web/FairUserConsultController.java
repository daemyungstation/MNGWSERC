...
@Controller
@RequestMapping(value="/mngwserc/fair/userconsult")
public class FairUserConsultController extends EmfController {
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/{fcSeq}/index.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/{fcSeq}/consultdetail.do")
...
//    		modelMap.addAttribute("memoMap", memoMap);
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/{fcSeq}/excel.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/{fcSeq}/memoselect.do")
	 ...
	 * @throws Exception
     */
	@RequestMapping(value="/{fcSeq}/memo_insert.ajax", method=RequestMethod.POST)
	 ...
	 * @throws Exception
     */
	@RequestMapping(value="/{fcSeq}/memo_delete.ajax", method=RequestMethod.POST)
	 ...
	 * @throws Exception
     */
	@RequestMapping(value="/{fcSeq}/delete.ajax", method=RequestMethod.POST)
	 ...
	 * @throws Exception
     */
	@RequestMapping(value="/{fcSeq}/status_change.ajax", method=RequestMethod.POST)
