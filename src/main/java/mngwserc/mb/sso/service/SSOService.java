package mngwserc.mb.sso.service;
...
public class SSOService extends EmfAbstractService {
    ...
    private HashMap requestSsoApi(String api, MultiValueMap<String, Object> body) throws Exception
    {
		...
		System.out.println("xxxxxxxxxxxxxx> : " + url);
		...
		System.out.println("xxxxxxxxxxxxxx> : " + conn); 
     ...
     */
    public HashMap update(String id, String ci, String ip, String name, String email, String phone, String cellPhone, String zipCode, String address, String addressDetail, String marketingAgreementFlag, String birth) throws Exception, SsoException
    {
        MultiValueMap<String, Object> body = new LinkedMultiValueMap<String, Object>();
        if (id != null && !id.equals("")) 
        	body.add("id", id);
