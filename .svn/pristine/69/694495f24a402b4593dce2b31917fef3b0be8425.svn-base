...
jQuery(function(){
	jQuery("#divCategoris")	
		...
		.jstree({ 
			...
			"json_data" : { 
				...
				"ajax" : {
					...
					"url" : "/mngwserc/cna/getCateJson.ajax",
		...
		.bind("create.jstree", function (event, data) {
			...
			{
				jQuery.post("/mngwserc/cna/insertCateMenu.ajax", 
					{ 
		...
		.bind("rename.jstree", function (event, data) {
			...
			{
				jQuery.post("/mngwserc/cna/updateCateMenuNm.ajax", 
					{ 
		...
		.bind("remove.jstree", function (event, data) {
			if (data.rslt.obj == undefined)
			{
				if(confirm("삭제하시겠습니까?"))
				{
					jQuery.post("/mngwserc/cna/deleteCateMenu.ajax",
						{ 
