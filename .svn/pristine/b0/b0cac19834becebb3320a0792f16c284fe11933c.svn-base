...
<div id="pop_wrap">
	...
	<div id="pop_container2" class="pop_container2">
    	<!-- content -->
		<form id="editor_upimage" name="editor_upimage" action="/mngwserc/editorimageupload/action.do" method="post" enctype="multipart/form-data" onSubmit="return false;" target="_blank">
			<div id="pop_content2">
				<input type="file" class="upload" id="uploadInputBox" name="uploadInputBox">				
				<p class="dsc" id="info"><strong>10MB</strong>이하의 이미지 파일만 등록할 수 있습니다.<br>(JPG, GIF, PNG, BMP)</p>
				<p class="dsc" id="info"><strong>이미지 설명</strong></p><input type="text" id="FileDescription" name="FileDescription" style="width:280px;" maxlength="200">
			</div>
		</form>
        <!-- //content -->
    </div>
    ...
    <div id="pop_footer">
	    <div class="btn_area">
            <a href="javascript:" ><img src="../../img/photoQuickPopup/btn_confirm.png" width="49" height="28" alt="확인" id="btn_confirm"></a>
            <a href="javascript:"><img src="../../img/photoQuickPopup/btn_cancel.png" width="48" height="28" alt="취소" id="btn_cancel"></a>
        </div>
    </div>
    <!-- //footer -->
</div>
