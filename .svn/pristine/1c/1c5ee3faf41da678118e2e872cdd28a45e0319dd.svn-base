...
<html lang="ko">
	<head>
		...
		<link href="/egov/seditor/css/smart_editor2.css" rel="stylesheet" type="text/css" />
		<script type="text/javascript" src="/egov/seditor/js/jindo.min.js" charset="utf-8"></script>
		<script type="text/javascript" src="/egov/seditor/js/jindo_component.js" charset="utf-8"></script>
		<script type="text/javascript" src="/egov/seditor/js/SE2B_Configuration.js" charset="utf-8"></script>
		<script type="text/javascript" src="/egov/seditor/js/SE2BasicCreator.js" charset="utf-8"></script>
		<script type="text/javascript" src="/egov/seditor/js/loader-min.js" charset="utf-8"></script>
		<style type="text/css">
	...
	<body>
		...
		<div id="smart_editor2">
			<div id="smart_editor2_content">
				<a href="#se2_iframe" class="blind">글쓰기영역으로 가기</a>
				<div class="se2_tool">
					<!-- icon toolbar -->
					...
					<div class="se2_text_tool">
						<ul class="se2_font_type">
							<li class="husky_seditor_ui_fontName">
								<button type="button" title="글꼴" class="se2_font_family"><span class="husky_se2m_current_fontName">글꼴</span></button>
								<!-- 글꼴 레이어 -->
								<div class="se2_layer husky_se_fontName_layer">
									<div class="se2_in_layer">
										<ul class="se2_l_font_fam" style="display:">
											...
											<li class="husky_seditor_font_nanummyeongjo"><button type="button"><span>OpenSans<span>(</span><em style="font-family:easyOpensans;">Abcdef</em><span>)</span></span></button></li>
										</ul>
									</div>
								</div>
								<!-- //글꼴 레이어 -->
							...
							<li class="husky_seditor_ui_fontSize">
								<button type="button" title="글자크기" class="se2_font_size"><span class="husky_se2m_current_fontSize">크기</span></button>
								<!-- 폰트 사이즈 레이어 -->
						...
						<ul class="se2_font_style">
							...
							<li class="se2_pair husky_seditor_ui_fontColor"><span class="husky_seditor_ui_fontColorA">
								<button type="button" title="글자색" class="se2_fcolor husky_se2m_fontColor_lastUsed" style="background-color:#4477f9;"><span>글자색</span></button></span><span class="husky_seditor_ui_fontColorB"><button type="button" title="더보기" class="se2_fcolor_more"><span>더보기</span></button></span>
								<!-- 글자색 -->
							...
							<li class="se2_pair husky_seditor_ui_BGColor">
								<span class="husky_seditor_ui_BGColorA"><button type="button" title="배경색" class="se2_bgcolor husky_se2m_BGColor_lastUsed" style="background-color:#4477f9;"><span>배경색</span></button></span><span class="husky_seditor_ui_BGColorB"><button type="button" title="더보기" class="se2_bgcolor_more"><span>더보기</span></button></span>
								<!-- 배경색 -->
						...
						<ul class="se2_etc se2_text_tool_view_more">
							<li class="husky_seditor_ui_text_more " id="se2_text_more">
								<button title="더보기" type="button" class="se2_text_tool_more"><span>더보기</span></button>
						...
						<ul class="se2_etc">
							<li class="husky_seditor_ui_hyperlink">
								<button type="button" title="링크" class="se2_url"><span>링크</span></button>
								<!-- 링크 -->
							...
							<li class="husky_seditor_ui_sCharacter">
								<button type="button" title="특수기호" class="se2_character"><span>특수기호</span></button>
								<!-- 특수기호 -->
							...
							<li class="husky_seditor_ui_table">
								<button type="button" title="표" class="se2_table"><span>표</span></button>
								<!-- 표 -->
										...
										<div class="se2_table_set">
											<fieldset>
												...
												<dl class="se2_cell_num">
													...
													<dd>
														<input id="row" name="" type="text" maxlength="2" value="4" class="input_ty2">
													...
													<dd>
														<input id="col" name="" type="text" maxlength="2" value="4" class="input_ty2">
												...
												<dl class="se2_t_proper1">
													...
													<dd>
														...
														<dl class="se2_t_proper1_1 se2_t_proper1_2">
															...
															<dd>
																<input id="se2_b_width" name="" type="text" maxlength="2" value="1" class="input_ty1">
														...
														<dl class="se2_t_proper1_1 se2_t_proper1_3">
															...
															<dd>
																...
																<span class="se2_pre_color"><button type="button" style="background:#cccccc;"><span>색찾기</span></button></span>
																<!-- 레이어 : 테두리색 -->
														...
														<dl class="se2_t_proper1_1 se2_t_proper1_4">
															...
															<dd>
																...
																<span class="se2_pre_color"><button type="button" style="background:#ffffff;"><span>색찾기</span></button></span>		
																<!-- 레이어 : 셀배경색 -->
																<div class="se2_layer se2_b_t_b1" style="clear:both;display:none;position:absolute;top:20px;left:-147px;">
											...
											<fieldset>
												...
												<dl class="se2_t_proper2">
													...
													<dd>
														<div class="se2_select_ty2"><span class="se2_t_style1 husky_se2m_table_style_preview"></span><button type="button" title="더보기" class="se2_view_more"><span>더보기</span></button></div>
														<!-- 레이어 : 표템플릿선택 -->
				...
				<hr>
				<!-- 입력 -->
				<div id="divArea" class="se2_input_area husky_seditor_editing_area_container">
					<div id="divBlackBackground" style="position:absolute; right:0; width:0px; height:100%; background-color:#999999;"></div>
					<script type="text/javascript">
						window.onresize = function(){
							var editorWidth = <fmt:message key="Globals.editorWidth" />;
							//document.getElementById("divBlackBackground").style.width = document.body.clientWidth - editorWidth + 2 + "px";
						}
					</script>
					<iframe src="about:blank" id="se2_iframe" name="se2_iframe" class="se2_input_wysiwyg" width="400" height="377" frameborder="0" scrolling="yes" title="글쓰기 영역 : 글쓰기 영역에서 빠져 나오시려면 Shift+ESC키를 누르세요" style="display:block;background-color: #FFFFFF;" ></iframe>
									...
									<div class="se2_qbody">
										...
										<div class="se2_qe2 se2_qe2_3">
											...
											<dl class="se2_qe2_1">
												...
												<dd>
													<span class="se2_pre_color"><button class="husky_se2m_table_qe_bgcolor_btn" type="button" style="background:#000000;"><span>색찾기</span></button></span>
													<!-- layer:셀배경색 -->
											...
											<dl class="se2_qe2_2 husky_se2m_tbl_qe_review_bg" style="display:block">
												...
												<dd>
													<span class="se2_pre_bgimg"><button type="button" class="se2_cellimg1 husky_se2m_table_qe_bgimage_btn"><span>배경이미지선택</span></button></span>
													<!-- layer:배경이미지선택 -->
